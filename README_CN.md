...
在 [Releases](https://github.com/%E4%BD%A0%E7%9A%84%E7%94%A8%E6%88%B7%E5%90%8D/%E4%BB%93%E5%BA%93%E5%90%8D/releases) 页面下载所需的 `.dll` 文件，放入游戏目录下的 `BepInEx/plugins` 目录中即可。
...
2. 启动游戏，检查 BepInEx 控制台或日志文件，确认 MOD 已成功加载。
...
本项目代码部分采用 **MIT 许可证** - 详情请见 [LICENSE](https://license/) 文件。

 **重要版权声明** ：

* 本 MOD 的源代码在 MIT 许可证下授权。
